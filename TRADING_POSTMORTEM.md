...
The real deliverable of this analysis is the negative result itself, and the tooling that produced it (`EDGE_AUDIT.md`, `resweep_fee.js`, the probe scripts): a clean, reusable benchmark showing the market reliably out-forecasts this model, and that the model's own pWin is a reliable *anti-signal*.
